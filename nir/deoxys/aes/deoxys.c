                         ...
                         uint8_t *ciphertext, size_t *c_len)
{
    ...
    if(ass_data_len) {
        ...
        while (16*(i+1) <= ass_data_len) {
            ...
            Encryption(KeyLen, ass_data+16*i, temp);
            /* Update Auth value */
        ...
        if ( ass_data_len > 16*i ) {
            ...
            Encryption(KeyLen, last_block, temp);
    ...
    while (16*(i+1) <= m_len) {
        ...
        Encryption(KeyLen, message+16*i, ciphertext+16*i);
        i++;
    }
    ...
    if (m_len > 16*i) {
        ...
        Encryption(KeyLen, zero_block, Pad);
        ...
        Encryption(KeyLen, Checksum, Final);
    }
    else{
        /*set_block_number_in_tweak(tweak, i);
                       ...
                       const uint8_t *ciphertext, size_t c_len)
{
    ...
    while(16*(i+1)<=c_len) {
        ...
        Encryption(KeyLen, ciphertext+16*i, message+16*i);
        xor_values(Checksum, message+16*i);
        i++;
    }
