...
void kuz_set_encrypt_key(/*kuz_key_t *kuz,*/ const unsigned char *key)
{
	int i, j;
	w128_t c, x, y, z;
...
void kuz_set_decrypt_key(/*kuz_key_t *kuz,*/ const unsigned char *key)
{
	int i;
...
void kuz_encrypt_block(/*kuz_key_t *key,*/ void *blk, void *c_blk)
{
	int i;
	__m128i x;
...
void kuz_decrypt_block(/*kuz_key_t *key,*/ void *blk, void *c_blk)
{
	int i, j;
	__m128i x;
