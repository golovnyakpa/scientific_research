...
int Setup(const unsigned char *skey)
{
	uint8 cst[16] = {0};
	//KeySchedule(KeyLen, ENC, skey);
	//printf("wow\n");
	kuz_set_encrypt_key(skey);
	//Encryption(KeyLen, cst, Q); // Q = E(0)
	kuz_encrypt_block(cst, Q);
	return SUCCESS;
}
/*
