...
static void process_block(
	...
	/*if(type_block == AD)  { Encryption(KeyLen, XX, X); } 
	if(type_block == MESSAGE) { Encryption(KeyLen, XX, X); }				
	if(type_block == CIPHERTEXT){  Encryption(KeyLen, XX, X); } */
    if(type_block == AD)  { kuz_encrypt_block(XX, X); } 
	if(type_block == MESSAGE) { kuz_encrypt_block(XX, X); }				
	if(type_block == CIPHERTEXT){  kuz_decrypt_block(X, XX); }
	/* ============= Linear Mixing =============== */
	if(type_block == AD) 
		xor_block(W,W,X);
	else 
	...
	/*if(type_block == MESSAGE) {  Encryption(KeyLen, YY, Y); }   
	if(type_block == CIPHERTEXT){  Encryption(KeyLen, YY, Y); }*/
	if(type_block == MESSAGE) {  kuz_encrypt_block(YY, Y); }   
	if(type_block == CIPHERTEXT){  kuz_decrypt_block(Y, YY); }
