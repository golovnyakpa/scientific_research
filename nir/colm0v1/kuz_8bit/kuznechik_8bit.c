...
void kuz_set_encrypt_key(/*kuz_key_t *kuz,*/ const unsigned char *key)//[32])//[32])
{
	int i, j;
	w128_t c, x, y, z;
...
void kuz_encrypt_block(/*kuz_key_t *key,*/ void *blk, void *c_blk)
{
	...
	((uint64_t *) c_blk)[0] = x.q[0] ^ ekey.k[9].q[0];
	((uint64_t *) c_blk)[1] = x.q[1] ^ ekey.k[9].q[1];
}
...
void kuz_decrypt_block(/*kuz_key_t *key,*/ void *blk, void *c_blk)
{
	...
	x.q[0] = ((uint64_t *) blk)[0] ^ ekey.k[9].q[0];
	x.q[1] = ((uint64_t *) blk)[1] ^ ekey.k[9].q[1];
